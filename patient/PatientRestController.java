...
@CrossOrigin(origins = { "http://localhost:55207", "htttp://localhost:2021" }, allowedHeaders = "*")
public class PatientRestController {
	...
	@GetMapping("/login/{patientName}/{password}")
	
	public Integer doLogin (@PathVariable String patientName,@PathVariable String password) throws  Exception{
		Patient patientFromDB = patientService.getPatientByPatientName(patientName);
		if (patientFromDB != null) {
			   System.err.println(patientFromDB);
			   System.err.println(password);
			   System.err.println(patientFromDB.getPassword());
			   
			   if(patientFromDB.getPassword().equals(password))
			   {
