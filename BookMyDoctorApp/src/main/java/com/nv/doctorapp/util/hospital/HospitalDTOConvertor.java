...
public class HospitalDTOConvertor {
	...
	public HospitalDTO convertTo(Hospital hospital) {
		...
		return new HospitalDTO(hospital.getHospitalId(), hospital.getHospitalName(), hospital.getCity(),
				hospital.getState(), hospital.getAddress(), hospital.getHospitalRating(), hospital.getImageName());
